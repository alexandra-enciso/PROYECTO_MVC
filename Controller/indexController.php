...
$opcion = $_POST['controller'];
if($opcion == "prestamo"){
    $objeto = new PrestamoController($_POST['codigoEjemplar'], $_POST['codigoUsuario'], $_POST['fechaPrestamo'], $_POST['fechaDevolucion']);
}
//Usuario
$opcion = $_POST['controller'];
    if($opcion == "usuario"){
        $objeto = new UsuarioController($_POST['codigoUsuario'], $_POST['nombre'], $_POST['telefono'], $_POST['direccion']);
    }
    if ($opcion == "UsuarioEditar"){
        $actualizar = new UsuarioController("","","","");
        //$actualizar->editar($_POST['codigoUsuario'], $_POST['nombre'], $_POST['telefono'], $_POST['direccion']);
    }
?>